...
class _PhotoApi implements PhotoApi {
  ...
  Future<PhotoUploadTicket> requestUploadUrl(
    RequestPhotoUploadRequest body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<PhotoUploadTicket>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/users/me/photos/upload-urls',
    ...
    late PhotoUploadTicket _value;
    try {
      _value = PhotoUploadTicket.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<PhotoResponse> confirm(int photoId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<PhotoResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/users/me/photos/${photoId}/confirm',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
