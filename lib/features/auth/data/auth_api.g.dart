...
class _AuthApi implements AuthApi {
  ...
  Future<PhoneVerificationResponse> requestPhoneVerification(
    ...
    final _data = body;
    final _options = _setStreamType<PhoneVerificationResponse>(
    ...
    late PhoneVerificationResponse _value;
    try {
      _value = PhoneVerificationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<PhoneVerificationConfirmResponse> confirmPhoneVerification(
    ...
    ConfirmPhoneVerificationRequest body,
  ) async {
    final _extra = <String, dynamic>{'skipAuth': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<PhoneVerificationConfirmResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PhoneVerificationConfirmResponse _value;
    try {
      _value = PhoneVerificationConfirmResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AuthSession> signup(SignupRequest body) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<AuthSession>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/auth/signup',
  ...
  @override
  Future<AuthTokens> refresh(RefreshTokenRequest body) async {
    final _extra = <String, dynamic>{'skipAuth': true};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
